  ...
  const onSubmit = (data: any) => {
    ...
    uploadAudioPromise.then((res) => {
      ...
      if (res.type === "uploads/uploadAudio/fulfilled") {
        const audioUrl = `${import.meta.env.VITE_API_URL}/upload/files/${res.payload.data}`;

        // Update full audio url
        ...
        uploadImagePromise.then((res) => {
          ...
          if (res.type === "uploads/uploadImage/fulfilled") {
            const imageUrl = `${import.meta.env.VITE_API_URL}/upload/files/${res.payload.data}`;
      ...
      if (res.type === "uploads/uploadAudio/rejected") {
